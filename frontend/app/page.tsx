        ...
        <section className="features-grid">
          <Link href="/tool?tab=hide" className="feature-card-link">
            <article>
              ...
              <span className="feature-cta">Try it →</span>
            </article>
          </Link>
          <Link href="/tool?tab=hide" className="feature-card-link">
            <article>
          ...
          <Link href="/tool?tab=analyze" className="feature-card-link">
            <article>
              ...
              <span className="feature-cta">Analyze an image →</span>
            </article>
          </Link>
          <Link href="/tool?tab=hide" className="feature-card-link">
            <article>
              ...
              <span className="feature-cta">Try deniability →</span>
            </article>
          </Link>
          <Link href="/tool?tab=hide" className="feature-card-link">
            <article>
              ...
              <span className="feature-cta">Create a link →</span>
            </article>
          </Link>
          <Link href="/tool?tab=reveal" className="feature-card-link">
            <article>
              ...
              <span className="feature-cta">Try Reveal →</span>
            </article>
          </Link>
        </section>
      </main>
